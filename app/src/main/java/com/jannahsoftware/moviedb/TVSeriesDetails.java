    ...
    private void BottomNav()
    {
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                {
                    case R.id.home:
                        startActivity(new Intent(TVSeriesDetails.this, MainActivity.class));
                        break;
                    case R.id.movies:
                        startActivity(new Intent(TVSeriesDetails.this, MovieOptions.class));
                        break;
                    case R.id.tvseries:
                        startActivity(new Intent(TVSeriesDetails.this, TVOptions.class));
                        break;
                    case R.id.search:
