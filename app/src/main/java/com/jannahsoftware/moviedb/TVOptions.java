...
public class TVOptions extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_tvoptions);
    ...
    private void BottomNav()
    {
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                {
                    case R.id.home:
                        startActivity(new Intent(TVOptions.this, MainActivity.class));
                        break;
                    case R.id.movies:
                        startActivity(new Intent(TVOptions.this, MovieOptions.class));
                        break;
                    case R.id.tvseries:
                        startActivity(new Intent(TVOptions.this, TVOptions.class));
                        break;
                    case R.id.search:
