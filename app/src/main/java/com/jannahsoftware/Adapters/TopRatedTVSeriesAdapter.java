...
public class TopRatedTVSeriesAdapter extends RecyclerView.Adapter<TopRatedTVSeriesAdapter.ViewAdapter>
{
    private List<TVSeries> tvSeriesList;
    private Context context;
    private boolean isLoaded = false;

    public TopRatedTVSeriesAdapter(List<TVSeries> tvSeriesList, Context context) {
    ...
    @NonNull
    @Override
    public TopRatedTVSeriesAdapter.ViewAdapter onCreateViewHolder(@NonNull ViewGroup parent, int viewType)
    {
        context = parent.getContext();
        LayoutInflater layoutInflater = LayoutInflater.from(context);

        View customview = layoutInflater.inflate(R.layout.movies_layout, parent, false);
        TopRatedTVSeriesAdapter.ViewAdapter viewAdapter = new TopRatedTVSeriesAdapter.ViewAdapter(customview, context);
        return viewAdapter;
    }

    @Override
    public void onBindViewHolder(@NonNull final TopRatedTVSeriesAdapter.ViewAdapter holder, final int position)
    {
