...
public class LatestTVSeriesAdapter extends RecyclerView.Adapter<LatestTVSeriesAdapter.ViewAdapter>
{
    private List<TVSeries> tvSeriesList;
    private Context context;
    private boolean isLoaded = false;

    public LatestTVSeriesAdapter(List<TVSeries> tvSeriesList, Context context) {
    ...
    @NonNull
    @Override
    public LatestTVSeriesAdapter.ViewAdapter onCreateViewHolder(@NonNull ViewGroup parent, int viewType)
    {
        context = parent.getContext();
        LayoutInflater layoutInflater = LayoutInflater.from(context);

        View customview = layoutInflater.inflate(R.layout.movies_layout, parent, false);
        LatestTVSeriesAdapter.ViewAdapter viewAdapter = new LatestTVSeriesAdapter.ViewAdapter(customview, context);
        return viewAdapter;
    }

    @Override
    public void onBindViewHolder(@NonNull final LatestTVSeriesAdapter.ViewAdapter holder, final int position)
    {
