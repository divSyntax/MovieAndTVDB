...
public class TVSeriesAiringTodayAdapter extends RecyclerView.Adapter<TVSeriesAiringTodayAdapter.ViewAdapter>
{
    private List<TVSeries> tvSeriesList;
    private Context context;
    private boolean isLoaded = false;

    public TVSeriesAiringTodayAdapter(List<TVSeries> tvSeriesList, Context context) {
    ...
    @NonNull
    @Override
    public TVSeriesAiringTodayAdapter.ViewAdapter onCreateViewHolder(@NonNull ViewGroup parent, int viewType)
    {
        context = parent.getContext();
        LayoutInflater layoutInflater = LayoutInflater.from(context);

        View customview = layoutInflater.inflate(R.layout.movies_layout, parent, false);
        TVSeriesAiringTodayAdapter.ViewAdapter viewAdapter = new TVSeriesAiringTodayAdapter.ViewAdapter(customview, context);
        return viewAdapter;
    }

    @Override
    public void onBindViewHolder(@NonNull final TVSeriesAiringTodayAdapter.ViewAdapter holder, final int position)
    {
