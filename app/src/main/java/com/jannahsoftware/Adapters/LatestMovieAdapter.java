...
public class LatestMovieAdapter  extends RecyclerView.Adapter<LatestMovieAdapter.ViewAdapter>
{
    private List<Movie> movieList;
    private Context context;
    private boolean isLoaded = false;

    public LatestMovieAdapter(List<Movie> movieList, Context context) {
    ...
    @NonNull
    @Override
    public LatestMovieAdapter.ViewAdapter onCreateViewHolder(@NonNull ViewGroup parent, int viewType)
    {
    ...
    @Override
    public void onBindViewHolder(@NonNull final LatestMovieAdapter.ViewAdapter holder, final int position)
    {
