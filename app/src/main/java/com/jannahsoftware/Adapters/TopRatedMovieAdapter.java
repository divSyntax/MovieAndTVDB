...
public class TopRatedMovieAdapter extends RecyclerView.Adapter<TopRatedMovieAdapter.ViewAdapter>
{
    private List<Movie> movieList;
    private Context context;
    private boolean isLoaded = false;

    public TopRatedMovieAdapter(List<Movie> movieList, Context context) {
    ...
    @NonNull
    @Override
    public TopRatedMovieAdapter.ViewAdapter onCreateViewHolder(@NonNull ViewGroup parent, int viewType)
    {
    ...
    @Override
    public void onBindViewHolder(@NonNull final TopRatedMovieAdapter.ViewAdapter holder, final int position)
    {
