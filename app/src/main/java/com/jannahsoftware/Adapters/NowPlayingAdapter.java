...
public class NowPlayingAdapter extends RecyclerView.Adapter<NowPlayingAdapter.ViewAdapter>
{
    ...
    @NonNull
    @Override
    public NowPlayingAdapter.ViewAdapter onCreateViewHolder(@NonNull ViewGroup parent, int viewType)
    {
    ...
    @Override
    public void onBindViewHolder(@NonNull final NowPlayingAdapter.ViewAdapter holder, final int position)
    {
